    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(RecipientRegistration.this, login.class);
        ...
        registerbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(bloodgroup.equals("Select your blood group")){
                    Toast.makeText(RecipientRegistration.this, "Select Blood Group", Toast.LENGTH_SHORT).show();
                    return;
                }
                    ...
                    mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                ...
                                Toast.makeText(RecipientRegistration.this, "Error"+error, Toast.LENGTH_SHORT).show();
                            }
                            else{
                                ...
                                userDatasbaseRef.updateChildren(userInfo).addOnCompleteListener(new OnCompleteListener() {
                                    ...
                                    public void onComplete(@NonNull Task task) {
                                        if(task.isSuccessful()){
                                            Toast.makeText(RecipientRegistration.this, "Data Set Successfully", Toast.LENGTH_SHORT).show();
                                        }else{
                                            Toast.makeText(RecipientRegistration.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                        }
                                ...
                                if(resultUri!=null){
                                    ...
                                    uploadTask.addOnFailureListener(new OnFailureListener() {
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            Toast.makeText(RecipientRegistration.this, "Image Upload Failed", Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                    ...
                                    uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            if(taskSnapshot.getMetadata()!=null && taskSnapshot.getMetadata().getReference()!=null){
                                                ...
                                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri uri) {
                                                        ...
                                                        userDatasbaseRef.updateChildren(newImageMap).addOnCompleteListener(new OnCompleteListener() {
                                                            ...
                                                            public void onComplete(@NonNull Task task) {
                                                                if(task.isSuccessful()){
                                                                    Toast.makeText(RecipientRegistration.this, "Image url added to database successfully", Toast.LENGTH_SHORT).show();
                                                                }else{
                                                                    Toast.makeText(RecipientRegistration.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                                }
                                                            }
                                                ...
                                                Intent intent=new Intent(RecipientRegistration.this,MainActivity.class);
                                                startActivity(intent);
                                                finish();
                                                loader.dismiss();
